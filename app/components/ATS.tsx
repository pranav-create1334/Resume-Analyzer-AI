  ...
  return (
    <div className={`w-full rounded-[2rem] border border-white/70 bg-gradient-to-b ${gradientClass} to-white p-6 shadow-[0_24px_70px_rgba(15,23,42,0.08)] sm:p-8`}>
      <div className="ats-layout">
        ...
        <div className="ats-stat self-start">
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">What this means</p>
          <p className="mt-3 text-4xl font-semibold text-slate-950">{score}</p>
          <p className="mt-2 text-sm leading-6 text-slate-600">
            Higher scores usually indicate stronger keyword match, clearer structure, and easier machine parsing.
          </p>
        </div>
      </div>
    </div>
